...
DEFAULT_EXAMPLES = [
    {
        ...
        "human": 4,
        "snapshot": "高结构化说明",
        "snippet": "人工智能系统正在以前所未有的速度推动信息生成，这使得教育工作者越来越难以区分真实的学生写作与由生成式模型产出的文本内容。",
        "doc_type": None,
        "length_label": None,
        "sort_order": 10,
    },
    {
        ...
        "human": 76,
        "snapshot": "个人经验表达",
        "snippet": "我在访谈每一位学生时，都会留意他们停顿时的迟疑、举例时的生活细节，以及他们如何把课堂讨论和自己的真实经历连接起来。",
        "doc_type": None,
        "length_label": None,
        "sort_order": 20,
    },
    {
        ...
        "human": 16,
        "snapshot": "AI 起草后人工重写",
        "snippet": "初始提纲由 AI 助手生成，但我重新撰写了每一段内容，补入最近期刊的引用，并按学院写作规范把语气调整得更克制、更正式。",
        "doc_type": None,
        "length_label": None,
        "sort_order": 30,
    },
    {
        ...
        "content": "完成初稿后，我重新整理了段落结构并压缩了重复表述，结果虽然更规整，但也让文本显得过于平均和顺滑。",
        "ai": 64,
        "mixed": 22,
        "human": 14,
        "snapshot": "规整改写版本",
        "snippet": "完成初稿后，我重新整理了段落结构并压缩了重复表述，结果虽然更规整，但也让文本显得过于平均和顺滑。",
        "doc_type": None,
        "length_label": None,
        "sort_order": 40,
    },
    ...
    },
    {
        ...
        "snippet": "Artificial intelligence systems have rapidly accelerated the pace of information creation, challenging educators to distinguish authentic student work from generated text.",
        "doc_type": None,
        "length_label": None,
        "sort_order": 10,
    },
    {
        ...
        "snippet": "When I interviewed each student, I paid attention to their pauses, their personal anecdotes, and the way they connected class discussions to their own experiences.",
        "doc_type": None,
        "length_label": None,
        "sort_order": 20,
    },
    {
        ...
        "snippet": "The initial outline was produced by an AI assistant, but I rewrote each paragraph to weave in citations from recent journals and to adjust the tone to match our faculty guidelines.",
        "doc_type": None,
        "length_label": None,
        "sort_order": 30,
    },
    {
        ...
        "content": "After revising the draft, I compressed repeated points and smoothed the transitions; the result reads more uniform, but also less grounded and more mechanically balanced.",
        "ai": 64,
        "mixed": 22,
        "human": 14,
        "snapshot": "Smoothed rewrite",
        "snippet": "After revising the draft, I compressed repeated points and smoothed the transitions; the result reads more uniform, but also less grounded and more mechanically balanced.",
        "doc_type": None,
        "length_label": None,
        "sort_order": 40,
    },
...
class ScanExampleService:
    ...
    def list_examples(self, locale: str) -> ScanExamplesResponse:
        ...
        hero_examples = [
            ScanHeroExampleItem(
                ...
                rhythm=self._build_hero_rhythm(item.locale, item.key),
                action=self._build_hero_action(item.locale, item.key),
            )
            for item in records
    ...
    @staticmethod
    def _build_hero_structure(locale: str, key: str) -> str:
        labels = {
            "zh-CN": {
                "chatgpt": "高度规整",
                "human": "自然起伏",
            ...
            "en-US": {
                "chatgpt": "Highly regular",
                "human": "Natural",
                "hybrid": "Moderately regular",
                "polished": "Over-smoothed",
            },
        }
        return labels.get(locale, labels["en-US"]).get(key, "")

    @staticmethod
    def _build_hero_rhythm(locale: str, key: str) -> str:
        labels = {
            "zh-CN": {
                "chatgpt": "重复偏高",
                "human": "较稳定",
            ...
            "en-US": {
                "chatgpt": "Repetitive",
                "human": "Stable",
                "hybrid": "Some stitched phrasing",
                "polished": "Low human detail",
            },
        }
        return labels.get(locale, labels["en-US"]).get(key, "")

    @staticmethod
    def _build_hero_action(locale: str, key: str) -> str:
        labels = {
            "zh-CN": {
                "chatgpt": "优先复核",
                "human": "可直接送检",
            ...
            "en-US": {
                "chatgpt": "Review first",
                "human": "Ready to scan",
                "hybrid": "Needs review",
                "polished": "Needs review",
            },
        }
        return labels.get(locale, labels["en-US"]).get(key, "")
